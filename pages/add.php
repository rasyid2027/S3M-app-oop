...
$add = new Crud();
$rows = $add->getSkillData();

if( isset($_POST['submit']) )
{
  $stmt = $add->addData($_POST);
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <select class="form-control selectric" name="skill_id">
                          <?php foreach( $rows as $row ) { ?>
                            <option value="<?= $row['s_id'] ?>"><?= $row['s_id'] . ". " . $row['s_name']  ?></option>
                          <?php } ?>
                        </select>
                      </div>
                    </div>
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" class="form-control inputtags" name="region" required="required">
                      </div>
                    </div>
                    <div class="form-group row mb-4">
