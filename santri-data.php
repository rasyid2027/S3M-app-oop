      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="active"><a class="nav-link" href="santri-data.html"><i class="fas fa-table"></i> <span>Santri Data</span></a></li>
            </ul>
        </aside>
      </div>
        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-button">
              <a href="?page=page1" class="btn btn-primary">Add New</a>
            </div>
          </div>
